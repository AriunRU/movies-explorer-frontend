        ...
        <section className='login'>
            ...
            <form name='login__form' className='login__form form'>
                <label className='login__input-box'>
                    ...
                    <input value={values.email || ''} onChange={handleChange} name='email' id='email' className={errors.email ? 'login__input login__input_error' : 'login__input'} type='email' placeholder='E-mail' minLength={2} maxLength={30} pattern="^[^@\s]+@[^@\s]+\.[^@\s]+$" required/>
                ...
                <label className='login__input-box'>
                    ...
                    <input value={values.password || ''} onChange={handleChange} name='password' id='password' className={errors.password ? 'login__input login__input_error' : 'login__input'} type='password' placeholder='Пароль' minLength={8} maxLength={30} required/>
            ...
            <button disabled={!isValid && props.isLoading} onClick={handleSubmit} form='login__form' type='submit' className={isValid ? "login__submit-button" : "login__submit-button login__submit-button_disabled"}>Войти</button>
